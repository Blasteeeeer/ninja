...
def initializeTrackbars(intialTracbarVals, wT=480, hT=240):
    ...
    cv2.createTrackbar("lower_v", "trackbar", 218, 255, nothing)
    cv2.createTrackbar("upper_h", "trackbar", 100, 255, nothing)
    cv2.createTrackbar("upper_s", "trackbar", 90, 255, nothing)
