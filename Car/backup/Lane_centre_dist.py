    ...
    with PiCamera() as camera:
        ...
        for frame in camera.capture_continuous(rawCapture, format="bgr",use_video_port=True):# use_video_port=True            
            ...
            if distance <= 15 and distance >=0:
                ...
                time.sleep(0.9)
                px.forward(0)
                centre_dist = round(px.ultrasonic.read(), 2)
                time.sleep(0.1)
                ...
                time.sleep(0.6)
                px.forward(0)
                right_dist = round(px.ultrasonic.read(), 2)
                ...
                time.sleep(0.6)
                px.forward(0)
                left_dist = round(px.ultrasonic.read(), 2)
                
                px.backward(1)
                time.sleep(0.6)
                px.forward(0)
                
                if (right_dist > left_dist) and (right_dist > centre_dist):
