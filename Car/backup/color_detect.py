...
def main():
    ...
    directory_path = '/home/pi/Car/Color_recording'
    ...
    out1 = cv2.VideoWriter("Color_recording/Original" + file_count + ".avi", fourcc1, 24.0, (640,480))
    out2 = cv2.VideoWriter("Color_recording/Output" + file_count + ".avi", fourcc2, 24.0, (320,40))
    ...
    with PiCamera() as camera:
        ...
        for frame in camera.capture_continuous(rawCapture, format="bgr",use_video_port=True):# use_video_port=True
            ...
            #recording the video
            img_stack = utlis.stackImages(1, ([resize_img, approved_green]))
            out1.write(img)
            out2.write(img_stack)
            
            cv2.imshow("crop_resize_img", resize_img)    # OpenCV image show
            cv2.imshow("approved_green", approved_green)
            cv2.imshow("original_image", img)    # OpenCV image show

    #         
    #         cv2.imshow("mask_red", mask_red)    # OpenCV image show
    #         cv2.imshow("mask_green", mask_green)    # OpenCV image show
    #         
    #         cv2.imshow("morphologyEx_img_red", approved_red)    # OpenCV image show
    #         cv2.imshow("morphologyEx_img_green", approved_green)    # OpenCV image show
...
#         obstacle.main()
#         
#         #import laneDetection_cam as ld
#         #Lane Detection
#         ld.main()
# #         print("deviation= ", deviation)
# #         print("direction=", directionDev)
...
def color_detect(img,color_name):
    ...
    #print("\n\contours\n", contours)
    #print("no. of contour = ", color_area_num)
